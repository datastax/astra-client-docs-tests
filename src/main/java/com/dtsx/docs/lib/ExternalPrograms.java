...
///
/// Factory for creating [ExternalProgram] instances with command overrides from [BaseScriptRunnerCtx].
///
...
public class ExternalPrograms {
    ...
    public static ExternalProgram tsx(BaseScriptRunnerCtx ctx) {
        return get(TSX, ctx);
    }
    ...
    public static ExternalProgram npm(BaseScriptRunnerCtx ctx) {
        return get(NPM, ctx);
    }
    ...
    public static ExternalProgram bash(BaseScriptRunnerCtx ctx) {
        return get(BASH, ctx);
    }
    ...
    public static ExternalProgram python(BaseScriptRunnerCtx ctx) {
    ...
    public static ExternalProgram java(BaseScriptRunnerCtx ctx) {
        return get(JAVA, ctx);
    }
    ...
    public static ExternalProgram dotnet(BaseScriptRunnerCtx ctx) {
    ...
    public static ExternalProgram custom(BaseScriptRunnerCtx ctx) {
        return new ExternalProgram(ctx, "custom", new String[0]);
    }

    private static ExternalProgram get(ExternalProgramType type, BaseScriptRunnerCtx ctx) {
    ...
    public record RunResult(int exitCode, List<OutputLine> outputLines) {
        ...
        /// Returns false if the exit code is 0.
    ...
    /// ```
    public record ExternalProgram(BaseScriptRunnerCtx ctx, String name, String[] cmd) {
