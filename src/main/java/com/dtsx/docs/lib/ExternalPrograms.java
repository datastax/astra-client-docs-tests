...
///
/// Factory for creating [ExternalProgram] instances with command overrides from [BaseCtx].
///
...
public class ExternalPrograms {
    ...
    public static ExternalProgram tsx(BaseCtx ctx) {
        return get(TSX, ctx);
    }
    ...
    public static ExternalProgram npm(BaseCtx ctx) {
        return get(NPM, ctx);
    }
    ...
    public static ExternalProgram bash(BaseCtx ctx) {
        return get(BASH, ctx);
    }
    ...
    public static ExternalProgram python(BaseCtx ctx) {
    ...
    public static ExternalProgram java(BaseCtx ctx) {
        return get(JAVA, ctx);
    }
    ...
    public static ExternalProgram dotnet(BaseCtx ctx) {
    ...
    public static ExternalProgram jq(BaseCtx ctx) {
        return get(JQ, ctx);
    }
